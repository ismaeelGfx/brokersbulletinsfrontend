...
//     const response =  dispatch(adminSignup(credentials));


//     console.log(response.arg,"SIGN UP TOAST ")
//     // toast("Sign up Successfully ")

//     if(response.arg.email != null || response.arg.email != '' )
//       {
...
const handleSubmit = (e) => {
    ...
    return (
        ...
        <div className='admin-singup-main'>
